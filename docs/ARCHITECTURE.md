...
Ainda não fazem parte do contrato vigente: CRUD de projetos, tecnologias, experiências e skills; geração por IA; PostgreSQL; integrações com GitHub ou plataformas de vagas; cache, métricas e rastreamento distribuído; score ATS; otimização por palavras-chave; evolução contínua dos Knowledge Assets.
